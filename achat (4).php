...
<?php
	...
	$conn = new mysqli("localhost", "root", "", "TPPHP");
	// Check connection
...
<title> Caise </title>
	...
	<p>
	 ...
	 <p> 
	 code article: <input type="text" name="codeArticle" id="codeArticle" /> 
  ...
  // output data of each row
	...
	echo "<tr> <td><img src=images/".$row["idArticle"].".jpg /></td> <td><h1>".$row["nomArticle"]."</h1></td> <td><h1>".$row["quantite"]."</h1></td> <td><h1>".$row["prixArticle"]."</h1></td></tr> ";
  ...
  // output data of each row
	...
	echo "<tr> <td><img src=images/".$row["id"].".jpg /></td> <td><h1>".$row["nomArticle"]."</h1></td> <td><h1>".$row["prix"]."</h1></td> </tr> ";
